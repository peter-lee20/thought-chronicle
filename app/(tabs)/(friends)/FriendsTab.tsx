...
/**
 * Props for the FriendsTab component.
 */
...
/**
 * FriendsTab component displays a list of friend requests with search functionality.
 *
 * @param {FriendsTabProps} props - The props for the FriendsTab component.
